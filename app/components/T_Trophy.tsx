...
const T_Trophy = () => {
  ...
  const trophyImage = maxScore >= 10 ? "/trophies/tteen.png" : "/trophies/un_teen.png";
  const trophyAlt = maxScore >= 10 ? "Teen Trophy Achieved" : "Teen Trophy Not Achieved";
