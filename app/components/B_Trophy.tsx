...
const B_Trophy = () => {
  ...
  const trophyImage = maxScore >= 5 ? "/trophies/tbaby.png" : "/trophies/un_baby.png";
  const trophyAlt = maxScore >= 5 ? "Baby Trophy Achieved" : "Baby Trophy Not Achieved";
